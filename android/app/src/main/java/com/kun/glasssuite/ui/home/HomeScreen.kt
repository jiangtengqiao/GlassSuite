package com.kun.glasssuite.ui.home
...
import com.kun.glasssuite.ui.common.PlaylistCard
                    ...
                    LazyRow(contentPadding = PaddingValues(horizontal = 16.dp)) {
                        items(newsongs) { song ->
                            androidx.compose.foundation.layout.Column(Modifier.padding(end = 12.dp)) {
                                com.kun.glasssuite.ui.common.CoverImage(
                                    song.albumPic,
...
private fun ToplistTab(onOpenPlaylist: (Long) -> Unit) {
    var loading by remember { mutableStateOf(true) }
    var list by remember { mutableStateOf<List<com.kun.glasssuite.data.ToplistItem>>(emptyList()) }
        ...
        list.isEmpty() -> EmptyBox("暂无数据")
            ...
            itemsIndexed(list) { i, item ->
                Row(
                    ...
                    com.kun.glasssuite.ui.common.CoverImage(item.coverImgUrl, Modifier.height(52.dp).fillMaxWidth(0.2f))
